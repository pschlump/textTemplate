...
func TestMissingFieldOnNil(t *testing.T) {
	...
	//want := "can't evaluate field MissingField in type *template.T"	// PJS - package name changed
	want := "can't evaluate field MissingField in type *textTemplate.T" // PJS - package name changed
